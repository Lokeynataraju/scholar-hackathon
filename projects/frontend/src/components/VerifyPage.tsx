                                ...
                                <div className="px-8 pb-8 relative -mt-14 flex flex-col items-center text-center">
                                    ...
                                    {badges.length > 0 && (
                                        <div className="flex flex-col gap-3 w-full mt-6">
                                            <button
                                                className="btn btn-primary btn-outline gap-2 normal-case w-full"
                                            ...
                                            <button
                                                className="btn btn-outline border-slate-700 text-slate-400 hover:bg-slate-800 hover:text-white gap-2 normal-case w-full"
                                                onClick={() => window.print()}
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                    <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z" /><path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5z" />
                                                </svg>
                                                Export Verified PDF
                                            </button>
                                        </div>
